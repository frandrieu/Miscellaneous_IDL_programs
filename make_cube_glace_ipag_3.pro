pro make_cube_glace_IPAG_3

output_file='/home/fandrieu/Inversion/Spectres_eau_IPAG/data_neige_slab_6eb.sav'
...
dims_data_gs_4[4]+dims_data_gs_5[4],nb)
...
dims_data_gs_4[4]+dims_data_gs_5[4]+dims_data_gs_6[4]+dims_data_gs_7[4]+dims_data_gs_8[4]+$
dims_data_gs_9[4]+dims_data_gs_10[4]+10,s1[3])
