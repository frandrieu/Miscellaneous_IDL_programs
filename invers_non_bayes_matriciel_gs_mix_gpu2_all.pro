...
pro invers_non_bayes_matriciel_gs_mix_gpu2_all
...
estim_param_gs=fltarr(nspectres, 8)
...
ngeom_gs=48
Param_cube_gs_mix=fltarr(npix_gs*(nmix+1L),8)
for mix=0,nmix do begin
for pp=0,4 do Param_cube_gs_mix[long(npix_gs)*mix:npix_gs*(mix+1L)-1L, pp]=Param_cube_gs[*,pp]
for pp=5,6 do Param_cube_gs_mix[long(npix_gs)*mix:npix_gs*(mix+1L)-1L, pp]=Param_cube_gs[*,pp+1]
Param_cube_gs_mix[long(npix_gs)*mix:npix_gs*(mix+1L)-1, 7]=1./nmix*mix*100.
endfor
...
grainsizeH2Ogranul_gs_mix=Param_cube_gs_mix[*,5]
grainsizeCO2granul_gs_mix=Param_cube_gs_mix[*,6]
propdustmix_gs=Param_cube_gs_mix[*,7]
...
fracco2granul_gs eq estim_param_gs[i,4] and grainsizeh2ogranul_gs  eq estim_param_gs[i,5] and grainsizeco2granul_gs eq estim_param_gs[i,6])
estim_spectres_gs[i,*]=cub_gs[pos_sp[0],*]*(1.-0.01*estim_param_gs[i,7])+dust*0.01*estim_param_gs[i,7]
...
var = 'propH2Ogranul_x, propCO2granul_x, grainH2Ogranul_x, grainCO2granul_x, propdustmix_x, azim_x, propH2Ogranul, propCO2granul, grainH2Ogranul, grainCO2granul, az_gs,' +$
'propdustmix, Lcube_gs, Param_cube_gs, nspectres, npix_gs, wavelengths, var, spectres, estim_spectres_gs, estim_param_gs, dates,' +$
'hgranul_evo, azim_evo, cgranul_evo, propH2Ogranul_evo, grainH2Ogranul_evo, propdustmix_evo, renorm_factor_gs'

save, propH2Ogranul_x, propCO2granul_x, grainH2Ogranul_x, grainCO2granul_x, propdustmix_x, azim_x, propH2Ogranul, propCO2granul, grainH2Ogranul, grainCO2granul, az_gs, $
propdustmix, Lcube_gs, Param_cube_gs, nspectres, npix_gs, wavelengths, var, spectres, estim_spectres_gs, estim_param_gs, dates, $
azim_evo, propH2Ogranul_evo, grainH2Ogranul_evo, propCO2granul_evo, grainCO2granul_evo, propdustmix_evo, renorm_factor_gs, time, filename=total_fileout[ligne]
