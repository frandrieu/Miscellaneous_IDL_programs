...
pro invers_non_bayes_matriciel_sd_mix_gpu2

total_fileout='/data/fschmidt/fandrieu/results_inversion_fixed_geom_noise_3percent_level_0dot05_ln_060913_mix_ds6_control_v3.sav' ; Fichier contenant les résultats de l'inversion
t=systime(1)
nc=247
nmix=10


restore, '/data/fschmidt/fandrieu/mat_covar_coef_renorm_noise_3percent_level_0dot05.sav' ; Matrice de covariance
